  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center max-w-5xl mx-auto text-center">
        ...
        <p className="max-w-3xl mb-4 text-lg leading-relaxed text-black sm:text-xl lg:text-2xl animate-fade-in-up animation-delay-200">
          At{" "}
        ...
        <p className="max-w-3xl mb-8 text-lg leading-relaxed text-black sm:text-xl lg:text-2xl animate-fade-in-up animation-delay-400">
        ...
        <div className="grid w-full max-w-4xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div
            className="relative p-6 overflow-hidden transition-all duration-500 shadow-md bg-white/90 backdrop-blur-md rounded-xl coffee-card group animate-coffee-pour"
        ...
        {/* <Link
          href="/about"
          className="inline-block mt-8 text-lg coffee-button sm:text-xl animate-fade-in-up animation-delay-800"
